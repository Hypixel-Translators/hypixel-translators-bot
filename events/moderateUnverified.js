...
async function check(client) {
    ...
    await client.guilds.cache.get("549503328472530974").roles.get("739111904672481280").members.forEach(async m => { //guid ID and Unverified
        if (m.joinedAt > alert) {
            ...
            client.channels.cache.get("662660931838410754").send("Sent an alert to **<@" + m.id + ">** as they've been stood in the server for 7 days without verifying.") //verify-logs
        }
    })
}