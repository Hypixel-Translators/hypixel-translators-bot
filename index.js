...
client.on("message", async message => {
  ...
  if (message.content.includes("/translate/") && message.content.includes("://")) {
    if (message.channel.id === "730042612647723058" || message.channel.id === "624881429834366986") // staff-bots and bot-dev
