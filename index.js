...
client.on("message", async message => {
  ...
  if (message.content.includes("/translate/") && message.content.includes("://")) if (message.channel.id === "549503328472530976" || message.channel.id === "627594632779399195") { // staff-bots and bot-dev
