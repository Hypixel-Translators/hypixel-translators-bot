...
async function crowdinVerify(message) {
	...
	if (!evalReturn) {
		//Send amazing message
		const embed = new Discord.MessageEmbed()
			.setColor(neutralColor)
			.setAuthor("Received message from staff")
			.setDescription(`Hey there! We noticed you sent us your Crowdin profile, however, you forgot to add your Discord tag to it! Just add ${message.author.tag} to your about section like shown in the image below. Once you've done so, send us the profile link again.\n\nIf you have any questions, be sure to send them here or in the <#569178590697095168> channel!`) //verify
