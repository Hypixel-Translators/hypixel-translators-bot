    ...
    execute(strings, message) {
        ...
        const rolesEmbed = new Discord.MessageEmbed()
            ...
            .addFields(
                ...
                {
                    name: "**Translators**", value: "<@&551758391127834625> - These are the managers of the Hypixel project on Crowdin. Please avoid tagging them (refer to rule 5).\n<@&645709877536096307> - These are the managers of the Quickplay project. They do the same as Hypixel Managers, but for Quickplay.\n<@748269219619274893> - These are the managers of the SkyblockAddons project. Permissions are the same as the previous ones\n<@752541221980733571> - These are the managers for our bot's project: the admins and our dev.\n<@&569839580971401236> - These are the Proofreaders for the Hypixel Crowdin project. They can pin important messages in their own language channels.\n<@&645709808745578496> - These are the Proofreaders for the Quickplay project. They have the same permissions as Hypixel Proofreaders\n<@748269222181863506> - These are the proofreaders for the SkyblockAddons project. Unless they are in the Hypixel/Quickplay projects, they won't have access to the language channels.\n<@752519784238678097> - These are our bot's proofreaders. You can contact them if there is an issue in your language.\n<@&569839517444341771> - These are the translators for the Hypixel project.\n<@&645709843436404767> - These are the translators for the Quickplay project.\n<@748268753405476905> - These are the translators for the SkyblockAddons project.\n<@749390356763902114> - These are the translators for our bot's project.".substring(0, 1024)
                },
                {
