    ...
    execute(strings, message) {
        ...
        const rolesEmbed = new Discord.MessageEmbed()
            ...
            .addFields(
                ...
                {
                    name: "**Translators**", value: "<@&551758391127834625>/<@&645709877536096307>/<@&748269219619274893>/<@&752541221980733571> - These are the managers for each one of the 4 projects we support on the server. Please avoid tagging them (refer to rule 5).\n<@&569839580971401236>/<@&645709808745578496>/<@&748269222181863506>/<@&752519784238678097> - These are the proofreaders for each one of the 4 projects we support on the server. They are in charge of approving strings on the projects so if you notice any mistakes, these are the people you should contact.\n<@&569839517444341771>/<@&645709843436404767>/<@&748268753405476905>/<@&749390356763902114> - These are the translators for each one of the 4 projects we support on the server. All they do is suggest translations and vote for others. **THIS IS A WIP**".substring(0, 1024)
                },
                {
