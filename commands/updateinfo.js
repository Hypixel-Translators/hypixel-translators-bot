...
module.exports = {
    ...
    execute(strings, message) {
        ...
        const channelsEmbed = new Discord.MessageEmbed()
            .setColor("#0022ff")
            .setTitle("Channels")
            .setThumbnail("https://media.discordapp.net/attachments/699367079241056347/699380437419819008/Untitled.png")
        ...
        const rolesEmbed = new Discord.MessageEmbed()
            ...
            .addFields(
                ...
                {
                    name: "**Translators**", value: "<@&551758391127834625>/<@&645709877536096307>/<@&748269219619274893>/<@&752541221980733571> - These are the managers for each one of the 4 projects we support on the server. Please avoid tagging them (refer to rule 5).\n<@&569839580971401236>/<@&645709808745578496>/<@&748269222181863506>/<@&752519784238678097> - These are the Proofreaders for the Hypixel Crowdin project. They can pin important messages in their own language channels.\n<@&569839517444341771>/<@&645709843436404767>/<@&748268753405476905>/<@&749390356763902114> - These are the translators for the Hypixel project. **THIS IS A WIP**".substring(0, 1024)
                },
                {
