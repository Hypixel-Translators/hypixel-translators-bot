...
module.exports = {
    ...
    execute(strings, message) {
        ...
        message.client.channels.cache.get("730042612647723058").send("", embed1)
        const embed2 = new Discord.MessageEmbed()
            .setColor(neutralColor)
            .setTitle("Roles")
            .setDescription("Some information will go here.")
            .addFields({ name: "Some header", value: "Some text" })
        message.client.channels.cache.get("730042612647723058").send("", embed2)
        ...
        message.client.channels.cache.get("730042612647723058").send("", embed3)
    }
}