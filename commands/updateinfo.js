    ...
    execute(strings, message) {
        ...
        const rolesEmbed = new Discord.MessageEmbed()
            ...
            .addFields(
                ...
                {
                    name: "**Translators**", value: "**Managers** - The managers of each project are the ones responsible for the behind the scenes stuff - everything from new strings to proofreader promotions are handled by them. Please avoid tagging people with these roles (refer to rule 5).\n**Proofreaders** - The proofreaders of each language are the ones responsible for reviewing and approving strings, so that they can be placed on the final product by the managers. If you notice any mistakes, these are the people you should contact first.\n**Translators** - A translator's job is to suggest and vote on translators, which helps the proofreaders' job a lot.".substring(0, 1024)
                },
                {
