  ...
  execute(message, args) {
    ...
    if (!args.length) {
      const embed = new Discord.MessageEmbed()
        ...
        .addFields(
          { name: commands.get("help").usage, value: commands.get("prefix").description, inline: true },
          { name: commands.get("prefix").usage, value: commands.get("prefix").description, inline: true },
          { name: commands.get("quote").usage, value: commands.get("prefix").description, inline: true },
          { name: commands.get("mention").usage, value: commands.get("prefix").description, inline: true },
          { name: commands.get("context").usage, value: commands.get("prefix").description, inline: true },
          { name: commands.get("bug").usage, value: commands.get("prefix").description, inline: true },
          { name: commands.get("feedback").usage, value: commands.get("prefix").description, inline: true }
        )
