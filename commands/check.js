      ...
      message.channel.send(embed).then(msg => {
        if (!args[0]) { //no arguments given - display bot and author perms
          ...
          const embed = new Discord.MessageEmbed()
            ...
            .addFields(
              { name: strings.ujoined, value: user.joinedAt.toLocaleString(strings.dateLocale, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', timeZone: "UTC", timeZoneName: "short" }), inline: true },
              { name: strings.ucreated, value: user.user.createdAt.toLocaleString(strings.dateLocale, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric', timeZone: "UTC", timeZoneName: "short" }), inline: true },
