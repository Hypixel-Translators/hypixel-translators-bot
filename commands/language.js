                ...
                fs.access(path, fs.F_OK, async (err) => {
                    if (!err) {
                        ...
                        oldFiMessages.forEach(async element => {
                            ...
                            await message.client.channels.cache.get("775004037443223563").send(oldMsg.join(" "))
                        })
                        ...
                        await newFiMessages.forEach(async element => {
                            ...
                            await element.delete()
                            await message.client.channels.cache.get("775004037443223563").send(newMsg.join(" "))
                            saved = true
                            const embed = new Discord.MessageEmbed()
