...
const command: Command = {
	...
	async execute(interaction) {
		const tag = interaction.options.getString("tag", true) as "invite" | "hypixel" | "guidelines" | "proofreader" | "minecraft" | "quickplay" | "skyblockaddons" | "thread" | "twitter",
		...
		switch (tag) {
			...
			case "proofreader":
				...
				break
			case "minecraft":
				response = 'Whenever you find terms in any of the projects that belong to Minecraft itself, you should always use the official translations from the game. You can find the official Minecraft Crowdin project [here](<https://crowdin.com/project/minecraft> "Minecraft Crowdin project") in order to see those.'
				break
			case "quickplay":
				response = 'Click [here](<https://crowdin.com/project/quickplay> "Quickplay Crowdin project") to access the Quickplay Crowdin project.\n' +
				...
				break
			case "skyblockaddons":
				response = 'Click [here](<https://crowdin.com/project/skyblockaddons> "SkyblockAddons Crowdin project") to access the SkyblockAddons Crowdin project.\n' +
				...
				break
			case "thread":
				response = 'You can find the official thread announcing this Discord server [here](<https://hypixel.net/threads/1970571> "Hypixel Translator Discord thread on the Hypixel forums").'
				break
			case "twitter":
				response = 'You can visit our official Twitter account [here](<https://twitter.com/HTranslators> "@HTranslators on Twitter"). Feel free to share it with all your friends!'
				break
			default:
