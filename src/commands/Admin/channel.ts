...
async function verify(interaction: Discord.CommandInteraction) {
    const verify = interaction.client.channels.cache.get("569178590697095168") as Discord.TextChannel,
        ...
        verifyEmbed = new Discord.MessageEmbed()
            ...
            .addFields(
                { name: "Translator/Proofreader", value: "If you are a translator or proofreader for either the **Hypixel**, **Quickplay** or **SkyblockAddons** projects, please run the /verify command with a link to your Crowdin profile (e.g. <https://crowdin.com/profile/ImRodry> **and not** <https://crowdin.com/profile>) in the `url` parameter so that you can be automatically verified. Keep in mind that in order to be verified, your profile must be **public** and you must include your Discord username and discriminator in your \"About me\" section (eg: Rodry#4020). If you don't receive your roles within 1 minute, please contact <@!240875059953139714>." },
